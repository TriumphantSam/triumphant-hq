                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-16 lg:gap-8">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <a
                                href="https://wa.me/2349090090910"
                                target="_blank"
                            ...
                            >
                                ...
                                <span className="text-xs text-gray-400 font-medium group-hover:text-white transition-colors truncate">+234 909 009 0910</span>
                            </a>
                        </div>
                    </div>
