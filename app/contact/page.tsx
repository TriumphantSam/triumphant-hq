          ...
          <div className="overflow-hidden rounded-[1.75rem] border border-slate-200/80 bg-white px-6 py-10 sm:px-10 sm:py-12 lg:px-12 lg:py-14">
            {sent ? (
              <div className="grid min-h-[420px] place-items-center text-center">
                <div>
                  <span className="mx-auto grid h-14 w-14 place-items-center rounded-2xl bg-blue-600 font-display text-xl font-bold text-white">
                    ✓
                  </span>
                  <h2 className="font-display mt-7 text-[1.75rem] font-bold tracking-[-0.03em] text-slate-950">
                    Your project enquiry is with us.
                  </h2>
                  <p className="mx-auto mt-4 max-w-sm text-[1.02rem] leading-7 text-slate-600">
                    We will review the details and reply within one business day.
                  </p>
                  <button className="button button-secondary mt-9" onClick={() => setSent(false)} type="button">
