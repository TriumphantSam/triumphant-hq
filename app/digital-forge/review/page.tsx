...
export default function ReviewPage() {
  return (
    <div style={{ background: "#ffffff", minHeight: "100vh", color: "var(--text-primary)", fontFamily: "sans-serif", overflow: "hidden" }}>
      ...
      <section style={{ position: "relative", paddingTop: "clamp(6rem,15vw,9rem)", paddingBottom: "clamp(4rem,10vw,6rem)" }}>
        ...
        <div className="max-w-screen-lg mx-auto px-6 sm:px-10 lg:px-16 relative" style={{ textAlign: "center" }}>
          ...
          <h1 style={{ fontSize: "clamp(2.4rem,5.5vw,4.4rem)", fontWeight: 900, lineHeight: 1.06, letterSpacing: "-0.03em", maxWidth: 820, margin: "0 auto 1.6rem" }}>
            ...
            <span style={{ color: "#075ee5" }}>a digital product?</span>
          </h1>
          ...
          <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
            <a href={whatsappHref} target="_blank" rel="noopener noreferrer" style={{ display: "inline-flex", alignItems: "center", gap: "0.6rem", padding: "1.1rem 2.2rem", background: "linear-gradient(135deg,#25D366,#128C7E)", color: "#fff", textDecoration: "none", fontWeight: 800, borderRadius: 12 }}>
            ...
            <a href="/digital-forge/checkout?offer=system" style={{ display: "inline-flex", alignItems: "center", padding: "1.1rem 2.2rem", border: "1px solid #64748b", color: "#334155", textDecoration: "none", fontWeight: 700, fontSize: "0.88rem", letterSpacing: "0.08em", textTransform: "uppercase", borderRadius: 12, background: "#64748b" }}>
      ...
      <section style={{ paddingBottom: "clamp(4rem,10vw,6rem)" }}>
        <div className="max-w-screen-lg mx-auto px-6 sm:px-10 lg:px-16">
          <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr]" style={{ alignItems: "center" }}>
            <div>
              <p style={{ color: "#0077b8", fontSize: "0.78rem", fontWeight: 700, letterSpacing: "0.2em", textTransform: "uppercase", marginBottom: "1rem", display: "flex", alignItems: "center", gap: "0.75rem" }}>
              ...
              <p style={{ color: "#334155", fontSize: "clamp(1.02rem,2.5vw,1.12rem)", lineHeight: 1.85 }}>
            ...
            <div style={{ background: "#ffffff", border: "1px solid #ffffff", borderRadius: 24, padding: "clamp(1.4rem,4vw,2.2rem)" }}>
              <p style={{ color: "#64748b", fontSize: "0.74rem", fontWeight: 700, letterSpacing: "0.16em", textTransform: "uppercase", marginBottom: "1.2rem" }}>Where most ideas get stuck</p>
              <div style={{ display: "flex", flexDirection: "column", gap: "0.9rem" }}>
                {PAIN_POINTS.map((item) => (
                  <div key={item} style={{ display: "flex", gap: "0.85rem", alignItems: "center" }}>
                    ...
                    <p style={{ color: "#334155", fontSize: "1rem", lineHeight: 1.6, margin: 0 }}>{item}</p>
                  </div>
                ))}
              </div>
            </div>
      ...
      <section style={{ paddingBottom: "clamp(4rem,10vw,6rem)" }}>
        <div className="max-w-screen-lg mx-auto px-6 sm:px-10 lg:px-16">
          <div style={{ textAlign: "center", maxWidth: 640, margin: "0 auto 3rem" }}>
            <p style={{ color: "#0077b8", fontSize: "0.78rem", fontWeight: 700, letterSpacing: "0.2em", textTransform: "uppercase", marginBottom: "1rem" }}>What I Will Check</p>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(220px,1fr))", gap: "1rem" }}>
            {REVIEW_CHECKS.map((item) => (
              <div key={item.label} style={{ background: "rgba(0,102,255,0.05)", border: "1px solid rgba(0,102,255,0.15)", borderRadius: 20, padding: "1.5rem", textAlign: "center" }}>
                ...
                <p style={{ color: "#334155", fontWeight: 600, fontSize: "1rem", lineHeight: 1.5, margin: 0 }}>{item.label}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section style={{ paddingBottom: "clamp(4rem,10vw,6rem)" }}>
        <div className="max-w-screen-lg mx-auto px-6 sm:px-10 lg:px-16">
          <div style={{ background: "linear-gradient(135deg, #ffffff 0%, #f4f8ff 100%)", border: "1px solid rgba(15,23,42,0.1)", borderRadius: 32, padding: "clamp(2rem,6vw,3.5rem)", boxShadow: "0 20px 60px rgba(15,23,42,0.08)" }}>
            <p style={{ color: "#0077b8", fontSize: "0.78rem", fontWeight: 700, letterSpacing: "0.2em", textTransform: "uppercase", marginBottom: "1rem", display: "flex", alignItems: "center", gap: "0.75rem" }}>
            ...
            <p style={{ color: "#334155", maxWidth: 600, lineHeight: 1.8, fontSize: "1.05rem", marginBottom: "2rem" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(200px,1fr))", gap: "0.7rem", marginBottom: "2.5rem" }}>
              {TOOLKIT_ITEMS.map((item) => (
                <div key={item} style={{ display: "flex", gap: "0.75rem", alignItems: "center" }}>
                  <span style={{ color: "#0077b8", fontWeight: 900, fontSize: "0.85rem" }}>→</span>
                  <p style={{ color: "#334155", fontSize: "0.95rem", lineHeight: 1.5, margin: 0 }}>{item}</p>
                </div>
              ))}
            </div>
        ...
        <div className="max-w-screen-lg mx-auto px-6 sm:px-10 lg:px-16">
          <div className="grid gap-10 lg:grid-cols-[auto_1fr]" style={{ alignItems: "start" }}>
            ...
            <div style={{ maxWidth: 680 }}>
              ...
              <p style={{ color: "#334155", lineHeight: 1.9, fontSize: "1.05rem", marginBottom: "1rem" }}>
              ...
              <p style={{ color: "#334155", lineHeight: 1.9, fontSize: "1.05rem" }}>
              ...
              <p style={{ color: "#64748b", marginTop: "2rem", fontWeight: 600, fontSize: "0.95rem" }}>— Adeyemi, Triumphant HQ</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* ── FAQ ── */}
      <section style={{ paddingBottom: "clamp(4rem,10vw,6rem)", borderTop: "1px solid rgba(15,23,42,0.11)", paddingTop: "clamp(4rem,10vw,6rem)" }}>
        <div className="max-w-screen-lg mx-auto px-6 sm:px-10 lg:px-16">
          <div style={{ textAlign: "center", maxWidth: 640, margin: "0 auto 3rem" }}>
            <p style={{ color: "#0077b8", fontSize: "0.78rem", fontWeight: 700, letterSpacing: "0.2em", textTransform: "uppercase", marginBottom: "1rem" }}>Common Questions</p>
            <h2 style={{ fontSize: "clamp(1.8rem,4vw,2.6rem)", fontWeight: 900, lineHeight: 1.1 }}>Before you send your idea</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 max-w-4xl mx-auto">
            {FAQ.map((item) => (
              <div key={item.q} style={{ background: "#ffffff", border: "1px solid #ffffff", borderRadius: 22, padding: "clamp(1.2rem,4vw,1.8rem)" }}>
                <h3 style={{ fontSize: "1.05rem", fontWeight: 700, marginBottom: "0.8rem" }}>{item.q}</h3>
                <p style={{ color: "#334155", fontSize: "0.97rem", lineHeight: 1.7, margin: 0 }}>{item.a}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section style={{ paddingBottom: "6rem" }}>
        <div className="max-w-screen-lg mx-auto px-6 sm:px-10 lg:px-16">
          <div style={{ background: "rgba(15,23,42,0.1)", border: "1px solid rgba(0,102,255,0.2)", borderRadius: 40, padding: "clamp(3rem,8vw,5rem) 2rem", textAlign: "center", boxShadow: "0 0 80px rgba(0,102,255,0.08)", position: "relative", overflow: "hidden" }}>
            ...
            <div style={{ position: "relative", zIndex: 10, maxWidth: 680, margin: "0 auto" }}>
              <p style={{ color: "#0077b8", fontSize: "0.78rem", fontWeight: 700, letterSpacing: "0.2em", textTransform: "uppercase", marginBottom: "1.4rem" }}>Your Move</p>
              <h2 style={{ fontSize: "clamp(2rem,5vw,3.4rem)", fontWeight: 900, lineHeight: 1.08, marginBottom: "1.4rem" }}>
                Send your idea.{" "}
                <span style={{ color: "#075ee5" }}>Get clarity.</span>
              </h2>
              <p style={{ color: "#334155", maxWidth: 540, margin: "0 auto 2.5rem", lineHeight: 1.8, fontSize: "1.05rem" }}>
                No sales pitch. No funnel trap. Just a real review of your product idea so you know what to build, fix, or launch next.
              </p>
              <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
                <a href={whatsappHref} target="_blank" rel="noopener noreferrer" style={{ display: "inline-flex", alignItems: "center", gap: "0.6rem", padding: "1.15rem 2.4rem", background: "linear-gradient(135deg,#25D366,#128C7E)", color: "#fff", textDecoration: "none", fontWeight: 800, borderRadius: 14 }}>
                  Send My Idea on WhatsApp
                </a>
                <a href="/digital-forge/checkout?offer=system" style={{ display: "inline-flex", alignItems: "center", padding: "1.15rem 2.4rem", border: "1px solid #64748b", color: "#334155", textDecoration: "none", fontWeight: 700, fontSize: "0.88rem", letterSpacing: "0.08em", textTransform: "uppercase", borderRadius: 14, background: "#64748b" }}>
                  Get the Starter System — <CurrencyPrice ngnLabel="₦15,000" usdLabel="$20.00" />
                </a>
              </div>
            </div>
