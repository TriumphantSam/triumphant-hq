    ...
    return (
        <div className="min-h-screen bg-white text-slate-900 overflow-x-hidden" style={{ fontFamily: "'Inter', system-ui, sans-serif" }}>
            ...
            <div style={{
                ...
                <p style={{ color: '#334155', fontSize: '14px', margin: 0, fontWeight: 500 }}>
            ...
            <section style={{
                ...
                <div style={{ maxWidth: '800px', margin: '0 auto', position: 'relative' }}>
                    ...
                    <h1 style={{
                        ...
                        lineHeight: 1.08, letterSpacing: '-0.03em', color: 'var(--text-primary)',
                        margin: '0 0 24px',
                    }}>
                    ...
                    <a href={offer.checkoutUrl || "#offer-cta"} style={{
                        ...
                        background: 'linear-gradient(135deg, #f59e0b 0%, #d97706 100%)',
                        color: 'var(--text-primary)', fontWeight: 800, fontSize: '1.15rem',
            ...
            <section style={{ padding: '100px 24px', maxWidth: '1040px', margin: '0 auto' }}>
                <div style={{ textAlign: 'center', marginBottom: '64px' }}>
                    <p style={{ color: '#0077b8', fontSize: '11px', fontWeight: 800, letterSpacing: '0.2em', textTransform: 'uppercase', marginBottom: '16px' }}>Complete System</p>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '16px', marginBottom: '60px' }}>
                    {offer.deliverables.map((item, i) => (
                        <div key={i} style={{
                            ...
                            <span style={{ color: '#334155', fontSize: '1rem', fontWeight: 600 }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: '32px', alignItems: 'start' }}>
                    ...
                    <div style={{
                        ...
                        <div style={{ display: 'flex', gap: '16px', alignItems: 'flex-start', marginBottom: '28px' }}>
                            <div style={{
                                width: 52, height: 52, background: 'linear-gradient(135deg, #ffffff 0%, #f5f8ff 100%)',
                                borderRadius: '12px', display: 'flex', alignItems: 'center', justifyContent: 'center',
                                fontWeight: 900, fontSize: '22px', color: 'var(--text-primary)', flexShrink: 0,
                            }}>T</div>
                            <div>
                                <p style={{ color: 'var(--text-primary)', fontWeight: 800, fontSize: '15px', margin: '0 0 4px' }}>TriumphantHQ</p>
                                <p style={{ color: '#64748b', fontSize: '12px', margin: 0 }}>Built from real systems, not theory</p>
                            </div>
                        </div>
                        <p style={{ color: '#334155', lineHeight: 1.75, fontSize: '0.95rem', marginBottom: '24px' }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                            {proof.evidenceBullets.map((ev, i) => (
                                <div key={i} style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
                                    ...
                                    <span style={{ color: '#64748b', fontSize: '13px' }}>{ev}</span>
                                </div>
                            ))}
                        </div>
                    </div>
                    ...
                    {/* FAQ */}
                    <div>
                        <p style={{ color: '#64748b', fontSize: '11px', fontWeight: 800, letterSpacing: '0.2em', textTransform: 'uppercase', marginBottom: '28px' }}>
                            Common Questions
                        </p>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '0' }}>
                            {pages.offerPage.faq.map((faq, i) => (
                                <div key={i} style={{
                                    padding: '24px 0',
                                    borderBottom: i < pages.offerPage.faq.length - 1 ? '1px solid rgba(15,23,42,0.11)' : 'none',
                                }}>
                                    <p style={{ color: 'var(--text-primary)', fontWeight: 700, fontSize: '1rem', marginBottom: '10px', display: 'flex', gap: '10px', alignItems: 'flex-start' }}>
                                        <span style={{ color: '#f59e0b', fontWeight: 900 }}>Q</span>
                                        {faq.question}
                                    </p>
                                    <p style={{ color: '#64748b', fontSize: '0.95rem', lineHeight: 1.7, margin: 0, paddingLeft: '22px' }}>
                                        {faq.answer}
                                    </p>
                                </div>
                            ))}
            ...
            <section id="offer-cta" style={{
                ...
                <div style={{ maxWidth: '680px', margin: '0 auto', position: 'relative' }}>
                    <p style={{ color: '#64748b', fontSize: '13px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.15em', marginBottom: '20px' }}>
                        Ready To Start?
                    </p>
                    <h2 style={{ fontSize: 'clamp(2rem, 5vw, 3.4rem)', fontWeight: 900, color: 'var(--text-primary)', marginBottom: '16px', letterSpacing: '-0.02em', lineHeight: 1.1 }}>
                        {offer.name}
                    </h2>
                    <p style={{ color: '#64748b', marginBottom: '48px', fontSize: '1.05rem', lineHeight: 1.7 }}>
                        {offer.summary}
                    </p>
                    ...
                    <div style={{
                        ...
                        boxShadow: '0 60px 100px rgba(15,23,42,0.12)',
                        marginBottom: '24px',
                    }}>
                        {displayPrice && (
                            <p style={{ fontSize: '3rem', fontWeight: 900, color: 'var(--text-primary)', margin: '0 0 8px', letterSpacing: '-0.02em' }}>
                                {displayPrice}
                            </p>
                        )}
                        ...
                        <a href={offer.checkoutUrl || "#offer-cta"} style={{
                            ...
                            background: 'linear-gradient(135deg, #f59e0b 0%, #d97706 100%)',
                            color: 'var(--text-primary)', fontWeight: 800, fontSize: '1.1rem',
                        ...
                        <div style={{
                            ...
                            {['Instant delivery', 'Secure checkout', 'Easy to follow'].map((t, i) => (
                                <span key={i} style={{ color: '#64748b', fontSize: '12px', display: 'flex', alignItems: 'center', gap: '6px' }}>
